...
<div class="card shadow-sm">
    <div class="card-header">
        <h1 class="mb-0">Tambah Alumni Baru</h1>
    </div>
    <div class="card-body">
        @if ($errors->any())
        ...
        <form action="{{ route('alumni.store') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="tahun_lulus" id="tahun_lulus" class="form-control @error('tahun_lulus') is-invalid @enderror" value="{{ old('tahun_lulus') }}" required min="1900" max="{{ date('Y') }}">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="pekerjaan_saat_ini" id="pekerjaan_saat_ini" class="form-control" value="{{ old('pekerjaan_saat_ini') }}">
                </div>

                <div class="col-12">
                    <label for="perusahaan_saat_ini" class="form-label">Perusahaan Saat Ini (Opsional)</label>
                    <input type="text" name="perusahaan_saat_ini" id="perusahaan_saat_ini" class="form-control" value="{{ old('perusahaan_saat_ini') }}">
                </div>

                <div class="col-12">
                    <label for="link_profil_linkedin" class="form-label">Link Profil LinkedIn (Opsional)</label>
                    <input type="url" name="link_profil_linkedin" id="link_profil_linkedin" class="form-control @error('link_profil_linkedin') is-invalid @enderror" value="{{ old('link_profil_linkedin') }}">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="posisi_awal" id="posisi_awal" class="form-control" value="{{ old('posisi_awal') }}">
                    </div>
                    <div class="col-md-6">
                        <label for="perusahaan_awal" class="form-label">Perusahaan Awal (Opsional)</label>
                        <input type="text" name="perusahaan_awal" id="perusahaan_awal" class="form-control" value="{{ old('perusahaan_awal') }}">
                    </div>
                    <div class="col-md-6">
                        <label for="bidang_keahlian_utama" class="form-label">Bidang Keahlian Utama (Opsional)</label>
                        <input type="text" name="bidang_keahlian_utama" id="bidang_keahlian_utama" class="form-control" value="{{ old('bidang_keahlian_utama') }}" placeholder="Contoh: Web Development, Data Analysis">
                    </div>
                    <div class="col-md-6">
                        <label for="info_kontak_karier" class="form-label">Info Kontak Karier (Email/WA, Opsional)</label>
                        <input type="text" name="info_kontak_karier" id="info_kontak_karier" class="form-control" value="{{ old('info_kontak_karier') }}">
                    </div>
                    <div class="col-12">
                        <label for="sertifikasi_profesional" class="form-label">Sertifikasi Profesional (Pisahkan dengan koma, Opsional)</label>
                        <textarea name="sertifikasi_profesional" id="sertifikasi_profesional" class="form-control" rows="3">{{ old('sertifikasi_profesional') }}</textarea>
                    </div>
                    <div class="col-12">
                        <div class="form-check mt-2">
                            <input class="form-check-input" type="checkbox" name="bersedia_menjadi_mentor" id="bersedia_menjadi_mentor" value="1" {{ old('bersedia_menjadi_mentor') ? 'checked' : '' }}>
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('alumni.index') }}" class="btn btn-outline-secondary me-2">
