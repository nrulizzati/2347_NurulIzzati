...
@section('title', 'Tambah Pengalaman Kerja untuk ' . $alumni->nama_lengkap)

@section('content')
<div class="card shadow-sm">
    <div class="card-header">
        <h1 class="mb-0">Tambah Pengalaman Kerja</h1>
        <h5 class="mb-0 text-muted">Untuk Alumni: {{ $alumni->nama_lengkap }}</h5>
    </div>
    <div class="card-body">
        @if ($errors->any())
        ...
        <form action="{{ route('alumni.pengalamanKerja.store', $alumni->id) }}" method="POST">
            @csrf
            <div class="row g-3">
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="lokasi_perusahaan" id="lokasi_perusahaan" class="form-control" value="{{ old('lokasi_perusahaan') }}">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    ...
                    <textarea name="deskripsi_pekerjaan" id="deskripsi_pekerjaan" class="form-control" rows="4">{{ old('deskripsi_pekerjaan') }}</textarea>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-save-fill me-2"></i>Simpan Pengalaman
                </button>
            </div>
        </form>
    </div>
